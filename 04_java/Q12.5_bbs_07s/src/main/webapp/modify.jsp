...
<form action="Xxx_modify" method="post">
<input type="hidden" name="num" value="<%=num%>">
토픽<br>
<select name="topick" class="inputvalue">
<option value ="null">토픽을 선택해주세요</option>
<option value ="lite">사는얘기</option>
<option value ="gathering">모임&스터디</option>
</select><br>
제목<br>
	<input name="title" value="<%=title %>" class="inputvalue2"><br>
아이디<br>
	<input name="id" value="<%=id %>" class="inputvalue2"><br>
내용<br>
	<textarea rows="20" cols="130" name="content" class="textarea"><%=content %></textarea><br>

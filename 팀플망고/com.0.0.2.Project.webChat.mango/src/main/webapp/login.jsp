	...
	<div id="main">
		...
		<div id="midBack">
			<div id="midleft">
				...
				<div id="mangotext">Mango Chat 0.00v</div>
			</div>
			<div id="midright">
				<div id="midrighttop">
					<div id="midPatch">
				...
				<div id="midrightbot">
					<div id="login">
					<form action="/com.0.0.2.Project.webChat.mango/ChatServlet" method="get">
						아이디:<input name="id"><br> 비밀번호:<input name="pw"><br>
						<input type="submit" value="로그인">
					</form>
						<a href="signUp.jsp"><input type="submit" value="회원가입"></a>
					</div>
				</div>
			</div>
		</div>

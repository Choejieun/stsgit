...
//			Cw.Wn("정상");
	...
	static public void public_item() {
		...
		if (Data.x == 0 && Data.y == 8) {
			imyn = "SELECT * FROM item WHERE I_MY = '0' and I_INT > 0  and I_FIELD = '"+ Data.Main_C_NAME+"';";
		}	else 	if (Data.x == 0 && Data.y == 20) {
			imyn = "SELECT * FROM item WHERE I_MY = '1' and I_INT > 0 and I_FIELD = '"+ Data.Main_C_NAME+"';";
		}	else 	if (Data.x == 220 && Data.y == 4) {
			imyn = "SELECT * FROM item WHERE I_MY = '2' and I_INT > 0 and I_FIELD = '"+ Data.Main_C_NAME+"';";
		}

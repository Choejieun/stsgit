...
public class Character {
	...
	static public void MAIN_C() {
		...
		String cmdname = String.format("insert into charinfo (C_NAME,C_MONEY,CANTDEL) value('%s',100,0);", Data.Main_C_NAME);
		try {
	...
	static public void MAIN_C_find_item_in() {
		...
		try (Statement newStatement = ProcBoard.con.createStatement()) {
			...
			while (ProcBoard.result.next()) {
				...
				int I_INT = ProcBoard.result.getInt("I_INT");
				int I_MONEY = ProcBoard.result.getInt("I_MONEY");
				String cmdgiveitem1 = String
						.format("insert into Inventory (IM_NAME, IM_TEXT, IM_INT,IM_MONEY,IM_MY) value('" 
				+ I_NAME+ "'," + "'" + I_TEXT + "'," + I_INT + "," + I_MONEY + ",'" + Data.Main_C_NAME + "');");
...
/////////////////////세이브 데이터 확인
	static public void saveDATA() {
		...
		try {
		       // ★ ProcBoard.result 초기화
	        ProcBoard.result = null;
			...
			while (ProcBoard.result.next()) { // 현재 가진 모든 결과출력
					...
					if (Integer.parseInt(cmd1) == no || "0".equals(cmd1)) {
						...
						try (Statement newStatement = ProcBoard.con.createStatement()) {
							...
							while (newResult2.next()) {
								int cantdel = ProcBoard.result.getInt("CANTDEL");
								if (cantdel == 1) {
									Cw.Wn("오̴̩͍̙͖̩́́̏̾̾̽̋͠͝류̶͈̗̟̺̼͙͗̄̄̏̓̑͢ͅ발͖͇͓̻͖̪̘̂̀͂͐͑͞생̫̟̞̬͈̬̬͚̜͛͒̋̑̂̚̚͘͠͝하̴̱̝͔̪̖͖̱̌͆͋̌͛̌̍͠람̷͚̘̦͖͛̒̍̿͟͝ㅈ̟͎̰͓̦̦͈̣̃͒͑̀͢͟͠ㄻ̷̧̻̮͚̗̬̞̟͖̽̂̇̋͊̓̍͌͛͟͡ㅈ̸̡̦̙͔̜̝̍̃͌̀̒́̇͠ㄻ̨̗̥̳̠̙̫̲͋̇͊͗̄͒͟͡͞ㅈ̴͇͔̤͚͍̗̤̱͌̄͑̑̈͐̕̚ㄹ̶̦̭̼̗̘̩͚̭̣̈̿̇̊̔̏̃͘乂乂乂乂乂乂乂乂乂乂乂乂乂乂乂乂乂乂乂乂乂");
									Cw.Wn("오̴̩͍̙͖̩́́̏̾̾̽̋͠͝류̶͈̗̟̺̼͙͗̄̄̏̓̑͢ͅ발͖͇͓̻͖̪̘̂̀͂͐͑͞생̫̟̞̬͈̬̬͚̜͛͒̋̑̂̚̚͘͠͝하̴̱̝͔̪̖͖̱̌͆͋̌͛̌̍͠람̷͚̘̦͖͛̒̍̿͟͝ㅈ̟͎̰͓̦̦͈̣̃͒͑̀͢͟͠ㄻ̷̧̻̮͚̗̬̞̟͖̽̂̇̋͊̓̍͌͛͟͡ㅈ̸̡̦̙͔̜̝̍̃͌̀̒́̇͠ㄻ̨̗̥̳̠̙̫̲͋̇͊͗̄͒͟͡͞ㅈ̴͇͔̤͚͍̗̤̱͌̄͑̑̈͐̕̚ㄹ̶̦̭̼̗̘̩͚̭̣̈̿̇̊̔̏̃͘乂乂乂乂乂乂乂乂乂乂乂乂乂乂乂乂乂乂乂乂乂");
									Cw.Wn("오̴̩͍̙͖̩́́̏̾̾̽̋͠͝류̶͈̗̟̺̼͙͗̄̄̏̓̑͢ͅ발͖͇͓̻͖̪̘̂̀͂͐͑͞생̫̟̞̬͈̬̬͚̜͛͒̋̑̂̚̚͘͠͝하̴̱̝͔̪̖͖̱̌͆͋̌͛̌̍͠람̷͚̘̦͖͛̒̍̿͟͝ㅈ̟͎̰͓̦̦͈̣̃͒͑̀͢͟͠ㄻ̷̧̻̮͚̗̬̞̟͖̽̂̇̋͊̓̍͌͛͟͡ㅈ̸̡̦̙͔̜̝̍̃͌̀̒́̇͠ㄻ̨̗̥̳̠̙̫̲͋̇͊͗̄͒͟͡͞ㅈ̴͇͔̤͚͍̗̤̱͌̄͑̑̈͐̕̚ㄹ̶̦̭̼̗̘̩͚̭̣̈̿̇̊̔̏̃͘삭제 캐삭빵 면제권으로 보호받고 있습니다!! ");
									Cw.Wn("오̴̩͍̙͖̩́́̏̾̾̽̋͠͝류̶͈̗̟̺̼͙͗̄̄̏̓̑͢ͅ발͖͇͓̻͖̪̘̂̀͂͐͑͞생̫̟̞̬͈̬̬͚̜͛͒̋̑̂̚̚͘͠͝하̴̱̝͔̪̖͖̱̌͆͋̌͛̌̍͠람̷͚̘̦͖͛̒̍̿͟͝ㅈ̟͎̰͓̦̦͈̣̃͒͑̀͢͟͠ㄻ̷̧̻̮͚̗̬̞̟͖̽̂̇̋͊̓̍͌͛͟͡ㅈ̸̡̦̙͔̜̝̍̃͌̀̒́̇͠ㄻ̨̗̥̳̠̙̫̲͋̇͊͗̄͒͟͡͞ㅈ̴͇͔̤͚͍̗̤̱͌̄͑̑̈͐̕̚ㄹ̶̦̭̼̗̘̩͚̭̣̈̿̇̊̔̏̃͘乂乂乂乂乂乂乂乂乂乂乂乂乂乂乂乂乂乂乂乂乂");
									Cw.Wn("오̴̩͍̙͖̩́́̏̾̾̽̋͠͝류̶͈̗̟̺̼͙͗̄̄̏̓̑͢ͅ발͖͇͓̻͖̪̘̂̀͂͐͑͞생̫̟̞̬͈̬̬͚̜͛͒̋̑̂̚̚͘͠͝하̴̱̝͔̪̖͖̱̌͆͋̌͛̌̍͠람̷͚̘̦͖͛̒̍̿͟͝ㅈ̟͎̰͓̦̦͈̣̃͒͑̀͢͟͠ㄻ̷̧̻̮͚̗̬̞̟͖̽̂̇̋͊̓̍͌͛͟͡ㅈ̸̡̦̙͔̜̝̍̃͌̀̒́̇͠ㄻ̨̗̥̳̠̙̫̲͋̇͊͗̄͒͟͡͞ㅈ̴͇͔̤͚͍̗̤̱͌̄͑̑̈͐̕̚ㄹ̶̦̭̼̗̘̩͚̭̣̈̿̇̊̔̏̃͘乂乂乂乂乂乂乂乂乂乂乂乂乂乂乂乂乂乂乂乂乂");
									return;
								}
						        Data.Main_C_NAME = newResult2.getString("C_NAME"); // 수정된 부분
				...
				if (delon == true) {
					...
					case "예":
						...
						String delnox4 = String.format("delete from item where I_FIELD = '%s';", Data.Main_C_NAME);
						ProcBoard.st.executeUpdate(delnox);
						ProcBoard.st.executeUpdate(delnox2);
						ProcBoard.st.executeUpdate(delnox3);
						ProcBoard.st.executeUpdate(delnox4);

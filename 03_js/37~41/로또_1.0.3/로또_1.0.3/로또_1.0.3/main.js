...
var rpcInputTextp0 // 내 로또번호 출력용 //1.0.3.ver
var rpcInputTextp1
var rpcInputTextp2
var rpcInputTextp3
var rpcInputTextp4
...
window.onload = function(){
    ...
    // 내가 적은 번호
    rpcInputTextp0 = document.getElementById("rpc_input_text_p0");       // 연결 R1번
    rpcInputTextp1 = document.getElementById("rpc_input_text_p1");       // 연결 R2번
    rpcInputTextp2 = document.getElementById("rpc_input_text_p2");       // 연결
    rpcInputTextp3 = document.getElementById("rpc_input_text_p3");       // 연결
    rpcInputTextp4 = document.getElementById("rpc_input_text_p4");       // 연결
    rpcInputTextp5 = document.getElementById("rpc_input_text_p5");       // 연결
    text = document.getElementById('checkbox_on_off');
...
for(i=0;i<=5; i=i+1){
    ...
    mym = player[0]+ ' '+player[1]+ ' '+player[2]+ ' '+player[3]+ ' '+player[4]+ ' '+player[5]+' ';
            ...
            //1.0.3.ver
        // 나의 추첨 번호 출력
        rpcInputTextp0.value = player[0]
        rpcInputTextp1.value = player[1]
        rpcInputTextp2.value = player[2]
        rpcInputTextp3.value = player[3]
        rpcInputTextp4.value = player[4]
        rpcInputTextp5.value = player[5]
    
    // endvalue = mym
//    endvalue = endvalue + "\n";
   endvalue = result;
    // my.value = mym +"<br>"+ result;
    my.innerHTML = endvalue;
    }

...
<script type="text/javascript">
    for (var i = 0; i < array.length; i++) {
        ...
        document.write("<div class='area mid'> <a class='redWord'>W :&nbsp;"+ winCount+"</a>&nbsp;&nbsp; <a class='blueWord'>L :&nbsp;" + loseCount + '</a>&nbsp; T : '+(loseCount + winCount)+'</div>');
...
<div class="result">
 ...
 <h3>패배</h3>
<a>날짜 : ${Matches.date} / 맵 : ${Matches.map.name}</a>
</div>
<div class="red">
<c:if test="${not empty Matches.playInfo.partyInfo}">
